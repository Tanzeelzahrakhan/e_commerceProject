...
import com.example.e_comerceproject.databinding.ItemCartBinding;
import com.example.e_comerceproject.databinding.QuantityDialogBinding;
...
public class CartAdapter  extends RecyclerView.Adapter<CartAdapter.CartViewHolder>{
    ...
    public CartAdapter(@NonNull Context context, ArrayList<Product> products,CartListener cartListener) {
